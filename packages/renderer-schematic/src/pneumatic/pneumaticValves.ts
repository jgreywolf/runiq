...
export const valve22Way = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ...
      ${renderConnectionLine(left + 10, top + 15, left + 10, top + 35, { strokeWidth: 2 })}
      ${renderConnectionLine(left + 5, top + 40, left + 10, top + 35, { strokeWidth: 2 })}
      ${renderConnectionLine(left + 15, top + 40, left + 10, top + 35, { strokeWidth: 2 })}

      <!-- Flow arrows in right position (open) -->
      ${renderConnectionLine(cx + 10, top + 10, cx + 10, bottom - 10, { strokeWidth: 2 })}
      ...
      <!-- Port A connection -->
      ${renderConnectionLine(left + 15, bottom, left + 15, bottom + 5, { strokeWidth: 2 })}
...
export const valve32Way = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ...
      ${renderConnectionLine(left + 5, bottom - 10, left + 10, top + 10, { strokeWidth: 2 })}
      <polygon points="${left + 10},${top + 10} ${left + 8},${top + 15} ${left + 12},${top + 15}"
        fill="currentColor"/>

      <!-- Flow arrows in right position (A->R) -->
      ${renderConnectionLine(cx + 10, top + 10, cx + 15, bottom - 10, { strokeWidth: 2 })}
...
export const valve42Way = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ...
      ${renderConnectionLine(left + 4, bottom - 5, left + 8, top + 5, { strokeWidth: 2 })}
      <polygon points="${left + 8},${top + 5} ${left + 6},${top + 10} ${left + 10},${top + 10}"
        fill="currentColor"/>
      ${renderConnectionLine(left + 12, bottom - 5, left + 16, top + 5, { strokeWidth: 2 })}
      <polygon points="${left + 16},${top + 5} ${left + 14},${top + 10} ${left + 18},${top + 10}"
        fill="currentColor"/>

      <!-- Flow paths in right position (P->B, A->R) -->
      ${renderConnectionLine(cx + 4, bottom - 5, cx + 16, top + 5, { strokeWidth: 2 })}
      ${renderConnectionLine(cx + 8, bottom - 5, cx + 4, top + 5, { strokeWidth: 2 })}
...
export const valve52Way = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ...
      ${renderConnectionLine(left + 4, bottom - 5, left + 10, top + 5, { strokeWidth: 2 })}
      <polygon points="${left + 10},${top + 5} ${left + 8},${top + 10} ${left + 12},${top + 10}"
        fill="currentColor"/>
      ${renderConnectionLine(left + 15, bottom - 5, left + 21, top + 5, { strokeWidth: 2 })}
      <polygon points="${left + 21},${top + 5} ${left + 19},${top + 10} ${left + 23},${top + 10}"
        fill="currentColor"/>

      <!-- Flow paths in right position -->
      ${renderConnectionLine(cx + 4, bottom - 5, cx + 16, top + 5, { strokeWidth: 2 })}
      ${renderConnectionLine(cx + 10, bottom - 5, cx + 4, top + 5, { strokeWidth: 2 })}
...
export const valve53ClosedCenter = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ...
      ${renderConnectionLine(left + 22, top + 20, left + 28, top + 30, { strokeWidth: 2 })}
      ${renderConnectionLine(left + 28, top + 20, left + 22, top + 30, { strokeWidth: 2 })}
      ${renderConnectionLine(left + 32, top + 20, left + 38, top + 30, { strokeWidth: 2 })}
      ${renderConnectionLine(left + 38, top + 20, left + 32, top + 30, { strokeWidth: 2 })}
...
export const valve53ExhaustCenter = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ...
      ${renderConnectionLine(left + 25, bottom - 10, left + 25, top + 10, { strokeWidth: 2 })}
      <polygon points="${left + 25},${top + 10} ${left + 22},${top + 15} ${left + 28},${top + 15}"
        fill="currentColor"/>
      ${renderConnectionLine(left + 35, bottom - 10, left + 35, top + 10, { strokeWidth: 2 })}
...
export const valve53PressureCenter = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ...
      ${renderConnectionLine(left + 24, bottom - 5, left + 30, cy, { strokeWidth: 2 })}
      ${renderConnectionLine(left + 30, cy, left + 36, bottom - 5, { strokeWidth: 2 })}
