...
export const cylinderSingleActing = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ...
      <!-- piston rod line -->
      ${renderConnectionLine(left, cy, left + 10, cy, { strokeWidth: 2 })}
...
export const cylinderTelescopic = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ...
      <!-- Inner rod -->
      ${renderConnectionLine(left, cy, left + 15, cy, { strokeWidth: 2 })}
...
export const gripperParallel = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ...
      <!-- Movement arrows -->
      ${renderConnectionLine(cx - 12, cy, cx - 8, cy, { strokeWidth: 1.5 })}
...
export const gripperAngular = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ...
      <!-- Left jaw (angled) -->
      ${renderConnectionLine(cx - width / 2, cy - height / 4, cx - width / 2 - 10, cy + height / 2, { strokeWidth: 3 })}
