...
export const capacitor = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ${renderConnectionLine(left, cy, plateLeft, cy, { strokeWidth: 2 })}
      ${renderConnectionLine(plateLeft, cy - 10, plateLeft, cy + 10, { strokeWidth: 2 })}
      ${renderConnectionLine(plateRight, cy - 10, plateRight, cy + 10, { strokeWidth: 2 })}
      ${renderConnectionLine(plateRight, cy, right, cy, { strokeWidth: 2 })}
    `;
  }
);
...
export const voltageSource = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ...
      ${renderConnectionLine(cx - radius + 10, cy, cx - radius + 4, cy, { strokeWidth: 1.5 })}
    `;
  }
);
...
export const currentSource = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ...
      ${renderConnectionLine(left, cy, cx - radius, cy, { strokeWidth: 2 })}
      ${renderConnectionLine(cx + radius, cy, right, cy, { strokeWidth: 2 })}
      ${renderConnectionLine(cx, cy - 8, cx, cy + 8, { strokeWidth: 1.5 })}
...
export const ground = createSymbol(
  ...
  (cx, cy) => {
    return `
      ${renderConnectionLine(cx, cy - 12, cx, cy, { strokeWidth: 2 })}
      ${renderConnectionLine(cx - 10, cy, cx + 10, cy, { strokeWidth: 2 })}
      ${renderConnectionLine(cx - 6, cy + 4, cx + 6, cy + 4, { strokeWidth: 2 })}
      ${renderConnectionLine(cx - 3, cy + 8, cx + 3, cy + 8, { strokeWidth: 2 })}
    `;
  }
);
...
export const diode = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      ${renderConnectionLine(left, cy, cx - 8, cy, { strokeWidth: 2 })}
      <path d="M ${cx - 8},${cy - 8} l 0,16 l 16,-8 z"
        fill="currentColor"
        stroke="currentColor"
        stroke-width="1"/>
      ${renderConnectionLine(cx + 8, cy - 8, cx + 8, cy + 8, { strokeWidth: 2 })}
      ${renderConnectionLine(cx + 8, cy, right, cy, { strokeWidth: 2 })}
    `;
  }
);
...
export const npnTransistor = createSymbol(
  ...
  (cx, cy) => {
    ...
    return `
      <!-- Base connection -->
      ${renderConnectionLine(baseX, cy, verticalLine, cy, { strokeWidth: 2 })}
      <!-- Vertical base line -->
      ${renderConnectionLine(verticalLine, cy - 15, verticalLine, cy + 15, { strokeWidth: 3 })}
      <!-- Collector -->
      ${renderConnectionLine(verticalLine, cy - 10, cx, cy - 30, { strokeWidth: 2 })}
      ${renderConnectionLine(cx, cy - 30, cx, cy - 30, { strokeWidth: 2 })}
      <!-- Emitter with arrow -->
      ${renderConnectionLine(verticalLine, cy + 10, cx, cy + 30, { strokeWidth: 2 })}
