...
diagram "BPMN Nested Pools" {
  ...
  // Customer swimlane
  container customerPool "Customer" backgroundColor:"#e3f2fd" borderColor:"#1976d2" {
  ...
  container companyPool "Company" backgroundColor:"#f3e5f5" borderColor:"#7b1fa2" {
    
    container salesDept "Sales Department" backgroundColor:"#fff9c4" borderColor:"#f57c00" {
    ...
    container fulfillmentDept "Fulfillment Department" backgroundColor:"#e8f5e9" borderColor:"#388e3c" {
...
- `backgroundColor`: Fill color for pool/lane
- `borderColor`: Border color for visual distinction
