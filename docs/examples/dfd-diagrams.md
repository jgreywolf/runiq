...
- [Data Flow Diagrams Guide](/guide/diagram-types/dfd-diagrams) - Complete guide to creating DFDs
...
- [Flowcharts](/guide/diagram-types/flowcharts) - Control flow diagrams
