...
diagram "Styled Flowchart" {
  ...
  shape start as @stadium label: "Start" fillColor: "#4ade80" color: "#ffffff"
  shape process as @rectangle label: "Process" fillColor: "#60a5fa" color: "#ffffff"
  shape decision as @rhombus label: "Decision?" fillColor: "#fbbf24" color: "#000000"
  shape end as @stadium label: "End" fillColor: "#f87171" color: "#ffffff"
