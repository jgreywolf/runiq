...
Here's a comprehensive comparison of the primary profiles to help you choose the right one for your project:

::: tip Quick Links
**Timeline**, **Railroad**, and **GlyphSet** profile guides:

- **Timeline Profile**: See [Timeline Diagrams Guide](/guide/timeline-diagrams)
- **Railroad Profile**: See [Railroad Diagrams Guide](/guide/railroad-diagrams)
...
| Feature                  | Diagram                                            | GlyphSet                                 | Sequence                                         | Timeline                                         | Electrical                                                                              | Digital                                                                           | Wardley                                                                           | Railroad                                         | Pneumatic                                                                             | Hydraulic                                                                             | P&ID                                        |
| ------------------------ | -------------------------------------------------- | ---------------------------------------- | ------------------------------------------------ | ------------------------------------------------ | --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ------------------------------------------------ | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------- |
| **Primary Use Case**     | General purpose, flowcharts, UML, architecture     | Template-based SmartArt                  | Object interactions, API flows                   | Chronological events, roadmaps                   | Circuit design, analog electronics                                                      | Logic circuits, digital design                                                    | Strategic mapping, technology evolution                                           | Grammar/syntax diagrams                          | Compressed air systems                                                                | Fluid power systems                                                                   | Process engineering, industrial plants      |
| **Rendering Style**      | Vector shapes, auto-layout                         | Preset layouts                           | Sequence notation                                | Axis + events                                    | IEEE schematic symbols                                                                  | Logic gate symbols                                                                | 2D axis plot                                                                      | Railroad rails, tokens                           | ISO 1219-1 symbols                                                                    | ISO 1219-2 symbols                                                                    | ISA-5.1 symbols                             |
| **Layout System**        | Auto (ELK), manual                                 | Preset layout                            | Vertical timeline                                | Timeline layout                                  | Orthogonal, schematic                                                                   | Auto-layout                                                                       | Manual 2D positioning                                                             | Deterministic LTR                                | Schematic layout                                                                      | Schematic layout                                                                      | Process flow layout                         |
| **Shapes Available**     | 52+ (all categories)                               | 61 glyphsets                             | Actors, lifelines, fragments                     | Events, periods, milestones                      | Resistors, caps, inductors, sources, diodes, transistors, ICs                           | Logic gates, flip-flops, mux, decoders                                            | Components, pipelines                                                             | Tokens, references, branches                     | Cylinders, valves, FRL, sensors                                                       | Pumps, motors, valves, cylinders, accumulators                                        | Equipment, pipes, instruments, valves       |
| **Export Formats**       | SVG (PNG/PDF via external conversion)              | SVG                                      | SVG                                              | SVG                                              | SPICE netlist, SVG                                                                      | Verilog HDL, SVG                                                                  | SVG                                                                               | SVG                                              | SVG                                                                                   | SVG                                                                                   | SVG                                         |
| **Simulation Support**   | No                                                 | No                                       | No                                               | No                                               | Yes (LTspice, ngspice)                                                                  | Yes (Icarus, ModelSim)                                                            | No                                                                                | No                                               | Manual analysis                                                                       | Manual analysis                                                                       | Process simulation                          |
| **Standards Compliance** | None (flexible)                                    | None                                     | UML 2.5                                          | None                                             | IEEE 315                                                                                | ANSI Y32.14                                                                       | Wardley mapping methodology                                                       | EBNF/railroad notation                           | ISO 1219-1:2012                                                                       | ISO 1219-2:2012                                                                       | ISA-5.1-2009                                |
| **Key Syntax**           | `shape`, `@shape_id`                               | `glyphset basicProcess`                  | `participant`, `lifeline`, `message`             | `timeline "Name"`                                | `part`, `net`, `pins:()`                                                                | `module`, `instance`, `input/output`                                              | `anchor`, `component`, `pipeline`                                                 | `diagram Expr = ...`                             | `equipment`, `line`, `actuator:`                                                      | `equipment`, `line`, `fluid:`                                                         | `equipment`, `pipe`, `instrument:`          |
| **Direction Control**    | TB, LR, BT, RL                                     | Orientation property                     | Vertical (fixed)                                 | Horizontal/vertical                              | Auto (schematic)                                                                        | Auto (logic)                                                                      | Manual coords                                                                     | LTR (fixed)                                      | Schematic flow                                                                        | Schematic flow                                                                        | Process flow                                |
| **Edge Styling**         | Arrows, labels, dashed                             | Template-defined                         | Messages, sync/async                             | Connectors, milestones                           | Wires, nets, connections                                                                | Wires, bus notation                                                               | Evolution arrows                                                                  | Rails, branches                                  | Air/pilot lines                                                                       | Pressure/return lines                                                                 | Process/instrument lines                    |
| **Typical Users**        | Software developers, architects, business analysts | Product teams, analysts                  | Software developers, API designers               | PMs, planners                                    | Electrical engineers, electronics hobbyists                                             | Digital designers, FPGA engineers                                                 | CTOs, product strategists, consultants                                            | Language designers, doc writers                  | Automation engineers, mechatronics                                                    | Hydraulic engineers, mobile equipment designers                                       | Process engineers, chemical plant designers |
| **Learning Curve**       | Easy (familiar shapes)                             | Easy                                     | Easy-Medium (UML basics)                         | Easy                                             | Medium (circuit knowledge)                                                              | Medium-Hard (logic design)                                                        | Medium (strategy concepts)                                                        | Easy-Medium                                      | Medium (pneumatic principles)                                                         | Medium-Hard (hydraulic principles)                                                    | Hard (process engineering)                  |
| **Documentation**        | [Getting Started](/guide/getting-started)          | [Glyphsets Guide](/guide/glyphsets)      | [Sequence Guide](/guide/sequence-diagrams)       | [Timeline Guide](/guide/timeline-diagrams)       | [Electrical Guide](/guide/electrical)                                                   | [Digital Guide](/guide/digital-circuits)                                          | [Wardley Maps](/guide/wardley-maps)                                               | [Railroad Guide](/guide/railroad-diagrams)       | [Pneumatic Guide](/guide/pneumatic-circuits)                                          | [Hydraulic Guide](/guide/hydraulic-circuits)                                          | [P&ID Guide](/guide/pid-diagrams)           |
| **Example Files**        | [Examples](/examples/)                             | [Glyphset Examples](/examples/glyphsets) | [Sequence Examples](/examples/sequence-diagrams) | [Timeline Examples](/examples/timeline-diagrams) | [examples/electrical](https://github.com/quipolabs/runiq/tree/main/examples/electrical) | [examples/digital](https://github.com/quipolabs/runiq/tree/main/examples/digital) | [examples/wardley](https://github.com/quipolabs/runiq/tree/main/examples/wardley) | [Railroad Examples](/examples/railroad-diagrams) | [examples/pneumatic](https://github.com/quipolabs/runiq/tree/main/examples/pneumatic) | [examples/hydraulic](https://github.com/quipolabs/runiq/tree/main/examples/hydraulic) | [examples/pid](/examples/pid-diagrams)      |
| **Export Capabilities**  | Standard graphics                                  | Standard graphics                        | Collaboration docs                               | Standard graphics                                | Circuit netlists                                                                        | HDL synthesis                                                                     | Strategic visualization                                                           | SVG                                              | System documentation                                                                  | System documentation                                                                  | Plant documentation                         |
| **Typical Complexity**   | Simple to complex                                  | Simple                                   | API/system level                                 | Simple to medium                                 | Medium circuits                                                                         | Small to medium                                                                   | Strategic level                                                                   | Small to medium                                  | Machine level                                                                         | Machine/system level                                                                  | Plant level                                 |
| **Real-Time Updates**    | Yes (editor)                                       | Yes (editor)                             | Yes (editor)                                     | Yes (editor)                                     | Yes (editor)                                                                            | Yes (editor)                                                                      | Yes (editor)                                                                      | Yes (editor)                                     | Yes (editor)                                                                          | Yes (editor)                                                                          | Yes (editor)                                |
| **Collaborative**        | Yes (text-based)                                   | Yes (text-based)                         | Yes (text-based)                                 | Yes (text-based)                                 | Yes (text-based)                                                                        | Yes (text-based)                                                                  | Yes (text-based)                                                                  | Yes (text-based)                                 | Yes (text-based)                                                                      | Yes (text-based)                                                                      | Yes (text-based)                            |
...
**Choose Railroad Profile** when:

- Documenting grammar and syntax rules (EBNF/BNF)
- Publishing language specs or parser docs
- Explaining token sequences with branches and loops
- Creating readable, left-to-right grammar diagrams
