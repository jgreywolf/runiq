...
```runiq
diagram "Pauli Gates" {
  shape X_gate as @gateX label: "X" fillColor: "#ffebee" strokeColor: "#000"
  shape Y_gate as @gateY label: "Y" fillColor: "#ffebee" strokeColor: "#000"
  shape Z_gate as @gateZ label: "Z" fillColor: "#ffebee" strokeColor: "#000"
}
```
...
diagram "Hadamard Gate" {
  shape H_gate as @gateH label: "H" fillColor: "#e8f5e9" strokeColor: "#000"
}
```
...
```runiq
diagram "Phase Gates" {
  shape S_gate as @gateS label: "S" fillColor: "#fff9c4" strokeColor: "#000"
  shape T_gate as @gateT label: "T" fillColor: "#fff9c4" strokeColor: "#000"
}
```
...
```runiq
diagram "Control Dot" {
  shape controlId as @controlDot label: "●" fillColor: "#000" strokeColor: "#000"
}
```
...
```runiq
diagram "CNOT Gate" {
  shape targetId as @cnotTarget label: "⊕" fillColor: "#fff" strokeColor: "#000"
  shape controlId as @controlDot label: "●" fillColor: "#000" strokeColor: "#000"
...
diagram "SWAP Gate" {
  ...
  shape swap2 as @swapX label: "⨉" fillColor: "#fff" strokeColor: "#000"
...
diagram "Phase Kickback" {
    ...
    shape q0 as @qubitWire label: "q0"
    shape q1 as @qubitWire label: "q1"
    shape H_control as @gateH label: "H" fillColor: "#e8f5e9" strokeColor: "#000"
    shape controlId as @controlDot label: "●" fillColor: "#000" strokeColor: "#000"
    shape target_init as @gateX label: "X" fillColor: "#ffebee" strokeColor: "#000"
    shape X_target as @gateX label: "X" fillColor: "#ffebee" strokeColor: "#000"
...
diagram "Clear Labels" {
    shape H_init as @gateH label: "H (init)" fillColor: "#e8f5e9" strokeColor: "#000"
    shape H_diff as @gateH label: "H (diff)" fillColor: "#e8f5e9" strokeColor: "#000"
}
```
...
diagram "Color Coding" {
    ...
    shape X_gate as @gateX label: "X" fillColor: "#ffebee" strokeColor: "#000"
    shape S_gate as @gateS label: "S" fillColor: "#fff9c4" strokeColor: "#000"
    shape M_gate as @measurement label: "M" fillColor: "#e3f2fd" strokeColor: "#000"
}
```
...
- **Documentation-First**: Perfect for quantum algorithm documentation and papers
- **Version Control**: Track quantum circuit evolution in Git
- **Qiskit-Compatible**: Visual style matches IBM Qiskit standard
- **Lightweight**: Quick visualization without quantum computing frameworks

**When to Use Alternatives:**

- **IBM Qiskit/Cirq**: Full quantum programming with simulation and hardware execution
- **Q# QDK**: Microsoft's quantum development with Visual Studio integration
