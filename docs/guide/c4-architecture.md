...
diagram "Styled C4 Diagram" {
  ...
  shape personShape as @c4Person label: "User" fillColor: "#08427b" color: "#ffffff"
  shape internalSystem as @c4System label: "Internal System" fillColor: "#1168bd" color: "#ffffff"
  shape externalSystem as @c4System label: "External System" fillColor: "#999999" color: "#ffffff"
  shape containerShape as @c4Container label: "Container" fillColor: "#438dd5" color: "#ffffff"
