...
description: Model object interactions over time with UML 2.5 sequence diagrams including messages, lifelines, fragments, gates, duration constraints, and interaction use.
