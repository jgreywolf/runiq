...
export const hvacSampleDiagrams: SampleCategory[] = [
	{
		id: 'hvac',
		label: 'HVAC Systems',
		samples: [
			{
				name: 'Office HVAC',
				description: 'Simple AHU with VAV and diffuser.',
				code: `hvac "Office HVAC System" {
  ...
  connect Diff1.out -> Return -> AHU1.in
			...
			{
				name: 'Rooftop Unit',
				description: 'RTU feeding a single zone.',
				code: `hvac "Rooftop Unit" {
