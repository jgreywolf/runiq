...
timeline "Software Project Launch" {
  ...
  event design date:"2024-02-20" label:"Design Approved" description:"UI/UX mockups finalized" textColor:"#3b82f6"
  
  event devStart date:"2024-03-01" label:"Development Starts" description:"Sprint 1 begins"
  
  event alpha date:"2024-04-15" label:"Alpha Release" description:"Internal testing version" textColor:"#f59e0b"
  
  event beta date:"2024-05-01" label:"Beta Release" description:"External user testing" textColor:"#f59e0b"
  
  event launch date:"2024-06-01" label:"Product Launch" description:"Public release v1.0" icon:"rocket" textColor:"#10b981"
...
timeline "Professional Development Journey" {
  ...
  orientation vertical
			...
			{
				name: 'Data-Driven Roadmap',
				description: 'Tasks mapped from a CSV datasource',
				badges: ['Data'],
				code: `// Data-driven tasks mapped into a timeline
// Uses a CSV datasource and map to tasks
