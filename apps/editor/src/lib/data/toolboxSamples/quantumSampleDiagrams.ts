...
export const quantumSampleDiagrams: SampleCategory[] = [
  ...
  shape cnot as @cnotTarget label: "⊕" fill: "#fff" strokeColor: "#000"
  shape ctrl as @controlDot label: "●" fill: "#000" strokeColor: "#000"
  shape m0 as @measurement label: "M" fill: "#e3f2fd" strokeColor: "#000"
  shape m1 as @measurement label: "M" fill: "#e3f2fd" strokeColor: "#000"
  ...
  shape h as @gateH label: "H" fill: "#e8f5e9" strokeColor: "#000"
  shape cnot1 as @cnotTarget label: "⊕" fill: "#fff" strokeColor: "#000"
  shape cnot2 as @cnotTarget label: "⊕" fill: "#fff" strokeColor: "#000"
