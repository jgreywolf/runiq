...
export const pneumaticSampleDiagrams: SampleCategory[] = [
  ...
  part VALVE type:VALVE_32 pins:(SUPPLY,PORT_A,EXHAUST) doc:"3/2-way valve"
  ...
  part GAUGE type:GAUGE_P pins:(REGULATED) doc:"Pressure gauge"
}`
			},
			{
  ...
  part V1 type:VALVE_52 pins:(SUPPLY,A_EXT,A_RET,EXH_A,EXH_A) doc:"Cylinder A valve"
  part V2 type:VALVE_52 pins:(SUPPLY,B_EXT,B_RET,EXH_B,EXH_B) doc:"Cylinder B valve"
