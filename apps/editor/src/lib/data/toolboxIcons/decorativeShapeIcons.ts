...
export const decorativeShapeIcons: ShapeCategory[] = [
	{
		...
		shapes: [
			...
			{ id: 'bracketLeft', label: 'Left Bracket', code: 'shape id as @bracketLeft data:[{ length: 220 }]' },
			{ id: 'bracketRight', label: 'Right Bracket', code: 'shape id as @bracketRight data:[{ length: 220 }]' },
			{ id: 'sectionHeader', label: 'Section Header', code: 'shape id as @sectionHeader label:"Section"' },
			{ id: 'swimlaneDivider', label: 'Swimlane Divider', code: 'shape id as @swimlaneDivider label:"Lane" data:[{ length: 220 }]' },
			{ id: 'titleBox', label: 'Title Box', code: 'shape id as @titleBox label:"Title"' },
			{ id: 'subtitleText', label: 'Subtitle Text', code: 'shape id as @subtitleText label:"Subtitle"' },
			...
			{ id: 'watermarkText', label: 'Watermark', code: 'shape id as @watermarkText label:"CONFIDENTIAL"' },
